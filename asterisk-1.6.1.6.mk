...
--without-pwlib --without-curl --with-dahdi --with-tonezone CFLAGS="$(ASTERISK_CFLAGS)" \
...
asterisk-package: asterisk $(PACKAGE_DIR)/asterisk_$(VERSION)_$(PKGARCH).ipk
	rcp -r /home/dan/dev/asterisk-1.6.1.6/channels/chan_dahdi.so root@192.168.1.80:/usr/lib/asterisk/modules
