cmd_drivers/dahdi/xpp/xpd_pri.mod.o := bfin-uclinux-gcc -Wp,-MD,drivers/dahdi/xpp/.xpd_pri.mod.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -mno-fdpic -mcpu=bf533-0.5 -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(xpd_pri.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(xpd_pri)" -DMODULE -mlong-calls -c -o drivers/dahdi/xpp/xpd_pri.mod.o drivers/dahdi/xpp/xpd_pri.mod.c

deps_drivers/dahdi/xpp/xpd_pri.mod.o := \
  drivers/dahdi/xpp/xpd_pri.mod.c \
...
drivers/dahdi/xpp/xpd_pri.mod.o: $(deps_drivers/dahdi/xpp/xpd_pri.mod.o)
