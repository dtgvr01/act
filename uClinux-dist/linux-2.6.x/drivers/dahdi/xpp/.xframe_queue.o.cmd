cmd_drivers/dahdi/xpp/xframe_queue.o := bfin-uclinux-gcc -Wp,-MD,drivers/dahdi/xpp/.xframe_queue.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -mno-fdpic -mcpu=bf533-0.5 -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign  -DDEBUG -DPOLL_DIGITAL_INPUTS -DDEBUG_PCMTX -DPROTOCOL_DEBUG -g   -DMODULE -mlong-calls -I -Idrivers/dahdi -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(xframe_queue)"  -D"KBUILD_MODNAME=KBUILD_STR(xpp)" -c -o drivers/dahdi/xpp/xframe_queue.o drivers/dahdi/xpp/xframe_queue.c

deps_drivers/dahdi/xpp/xframe_queue.o := \
...
drivers/dahdi/xpp/xframe_queue.o: $(deps_drivers/dahdi/xpp/xframe_queue.o)
