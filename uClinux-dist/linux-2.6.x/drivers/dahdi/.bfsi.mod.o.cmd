cmd_drivers/dahdi/bfsi.mod.o := bfin-uclinux-gcc -Wp,-MD,drivers/dahdi/.bfsi.mod.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -mno-fdpic -mcpu=bf533-0.5 -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(bfsi.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(bfsi)" -DMODULE -mlong-calls -c -o drivers/dahdi/bfsi.mod.o drivers/dahdi/bfsi.mod.c

deps_drivers/dahdi/bfsi.mod.o := \
  drivers/dahdi/bfsi.mod.c \
...
drivers/dahdi/bfsi.mod.o: $(deps_drivers/dahdi/bfsi.mod.o)
