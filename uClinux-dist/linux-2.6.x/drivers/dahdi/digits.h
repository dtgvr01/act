...
#define DEFAULT_DTMF_LENGTH	100 * DAHDI_CHUNKSIZE_LOW
#define DEFAULT_MFR1_LENGTH	68 * DAHDI_CHUNKSIZE_LOW
#define DEFAULT_MFR2_LENGTH	100 * DAHDI_CHUNKSIZE_LOW
#define	PAUSE_LENGTH		500 * DAHDI_CHUNKSIZE_LOW
