cmd_drivers/dahdi/dahdi_echocan_kb1.mod.o := bfin-uclinux-gcc -Wp,-MD,drivers/dahdi/.dahdi_echocan_kb1.mod.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -mno-fdpic -mcpu=bf533-0.5 -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(dahdi_echocan_kb1.mod)"  -D"KBUILD_MODNAME=KBUILD_STR(dahdi_echocan_kb1)" -DMODULE -mlong-calls -c -o drivers/dahdi/dahdi_echocan_kb1.mod.o drivers/dahdi/dahdi_echocan_kb1.mod.c

deps_drivers/dahdi/dahdi_echocan_kb1.mod.o := \
  drivers/dahdi/dahdi_echocan_kb1.mod.c \
...
drivers/dahdi/dahdi_echocan_kb1.mod.o: $(deps_drivers/dahdi/dahdi_echocan_kb1.mod.o)
