cmd_drivers/dahdi/bfsi.o := bfin-uclinux-gcc -Wp,-MD,drivers/dahdi/.bfsi.o.d  -nostdinc -isystem /opt/uClinux/bfin-uclinux/lib/gcc/bfin-uclinux/4.1.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -O2 -mno-fdpic -mcpu=bf533-0.5 -fomit-frame-pointer  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign   -DMODULE -mlong-calls -I -Idrivers/dahdi -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(bfsi)"  -D"KBUILD_MODNAME=KBUILD_STR(bfsi)" -c -o drivers/dahdi/bfsi.o drivers/dahdi/bfsi.c

deps_drivers/dahdi/bfsi.o := \
  drivers/dahdi/bfsi.c \
    $(wildcard include/config/bf537.h) \
...
drivers/dahdi/bfsi.o: $(deps_drivers/dahdi/bfsi.o)
